...
import { registerSetupProvider, type ProviderAuthOptions } from './registry.js';
...
export async function runCursorAuthStep(options: ProviderAuthOptions = {}): Promise<void> {
