 ...
 * core (4.32.0) parses assistant_thread_started / app_context_changed into a
 ...
 * chat core (4.32.0) does NOT dispatch — see the TODO at the
...
export function createChatSdkBridge(config: ChatSdkBridgeConfig): ChannelAdapter {
  ...
  const bridge: ChannelAdapter = {
    ...
    async setup(hostConfig: ChannelSetup) {
      ...
      // viewing" per (channel, user). The installed chat core (4.32.0)
